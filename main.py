...
import numpy as np
import random
from models.dynamic_vit_viz import vit_register_dynamic_viz
import utils
from tome.patch.vit_tome import apply_patch
from cifar_engine.cifar_test import test_model
from cifar_engine.cifar_train import train_model
import tome
from utils.custom_summary import custom_summary
...
model.r = 16
# custom_summary(model, (3, 224, 224))
print("Testing model after ToMe patch...")
...
print("Applying ToMe with decreasing schedule...")
# custom_summary(model, (3, 224, 224))
